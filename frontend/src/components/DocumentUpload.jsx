        ...
        <div className="mb-8">
            ...
            <div className="border-2 border-dashed border-purple-500/30 rounded-lg p-8 text-center hover:border-purple-500/60 transition-colors bg-white/5">
                ...
                <button
                    ...
                    className="bg-white/10 border border-white/20 text-white px-8 py-3 rounded-xl hover:bg-white/20 disabled:opacity-50 transition-all duration-500 ease-aristide shadow-md"
                >
                    {isProcessing ? (
